...
const
  VPI_INVALID_ISSUER = 101;   { // El c�digo de tarjeta no existe. }
  VPI_INVALID_TICKET = 102;   { // El n�mero de cup�n no existe. }
  VPI_INVALID_PLAN = 103;     { // El c�digo de plan no existe. }
  VPI_INVALID_INDEX = 104;    { // No existe el indice }
  VPI_EMPTY_BATCH = 105;      { // El lote del POS se encuentra vac�o. }

const
  VPI_TRX_CANCELED = 201;     { // Transacci�n cancelada por el usuario. }
  VPI_DIF_CARD = 202;         { // La tarjeta deslizada por el usuario no coincide con la pedida. }
  VPI_INVALID_CARD = 203;     { // La tarjeta deslizada no es v�lida. }
  VPI_EXPIRED_CARD = 204;     { // La tarjeta deslizada est� vencida. }
  VPI_INVALID_TRX = 205;      { // La transacci�n original no existe. }
...
const
  ...
  VPI_INVALID_IN_PARAM = 902; { // Formato de alg�n par�metro de entrada no es correcto. }
  VPI_INVALID_OUT_CMD = 903;  { // El comando enviado por }
  VPI_GENERAL_FAIL = 909;     { // Error general en la operaci�n. }
...
const
  ...
  VPI_VOID = 2;         { // Anulaci�n de venta }
  VPI_REFUND = 3;       { // Devoluci�n }
  VPI_REFUND_VOID = 4;  { // Anulaci�n de devoluci�n }

  { +//* }
  { -* Timeouts }
  { = }
const
  VPI_TIMEOUT_STD = 3000;   { // Timeout m�nimo 3 segundos }
